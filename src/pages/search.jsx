            ...
            <div className="fixed z-30 w-screen mt-8">
                <div className="w-4/5 backgroundtransprant m-auto py-2.5 px-11 rounded-full border border-fuchsia-950 border-solid">
                    <form onSubmit={(e)=>{e.preventDefault();router.push(`/search/${searchQuery}/1`);}} className="flex">
                        ...
                        <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="inputtag placeholder-slate-400 focus:outline-none focus:border-red-950 focus:ring-red-600 block focus:ring-0 backgroundtransprant w-full rounded-lg border-red-950 border bg-red-300 border-solid px-10 mx-10 bg-transparent text-xl" placeholder="Movies, Shows and more ..." />
